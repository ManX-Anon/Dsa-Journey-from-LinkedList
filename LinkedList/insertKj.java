...
class LinkedList{
	...
	if (lengthOfLL(head) < k-1) {
		System.out.println("Enter valid index, There are only "+lengthOfLL(head)+" elements present in this LinkedList.");
		System.exit(1);
	}
	if (head == null) {
	...
	public static void main(String[] args){
		...
		choice = sc.nextInt();
		System.out.print("\nEnter an index where you want to insert the number: ");
		index = sc.nextInt();
